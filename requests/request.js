...
function getBooks(successCallback, errorCallback, completeCallback) {
    requestData(api.getBooks(), {}, successCallback, errorCallback, completeCallback);
}
...
function getList(bookId, successCallback, errorCallback, completeCallback) {
  requestData(api.getList(bookId), {}, successCallback, errorCallback, completeCallback);
}
